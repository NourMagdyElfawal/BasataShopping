...
public class RetrofitClientCloudMessaging {
    private static final String BASE_URL="https://fcm.googleapis.com/";
    private static RetrofitClientCloudMessaging mInstance;
    ...
    private RetrofitClientCloudMessaging(){
    ...
    public static synchronized RetrofitClientCloudMessaging getInstance(){
        if (mInstance==null){
            mInstance=new RetrofitClientCloudMessaging();
        }
        return mInstance;
    }
