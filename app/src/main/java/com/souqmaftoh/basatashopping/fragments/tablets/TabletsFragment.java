package com.souqmaftoh.basatashopping.fragments.tablets;
...
//        homeAdapter = new HomeAdapter(getActivity(), historicList);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(TabletsViewModel.class);
...
//                "اوبو",
        ...
        Log.d("TabletsFragment", "List count: " + imageTitleList.size());
